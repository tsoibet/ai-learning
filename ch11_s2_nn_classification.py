...
df = pd.read_csv('./data/sample11_2_1.csv')
train_df = df[:1000]
test_df = df[1000:]
...
torch.save(model.state_dict(), 'sample11_2.pth')
torch.save({'losses': losses, 'accuracies': accuracies}, 'sample11_2.hst')
print("Done!")

#Visualisation of learning process
import matplotlib.pyplot as plt
history = torch.load('./sample11_2.hst')
